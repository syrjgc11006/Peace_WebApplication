...
namespace Peace.Core.Helpers
{
    public class SendMail
    {
        ...
        public SendMail()
        {
            ...
            MailhostUsername =PeaceConstConfig.MailhostUsername;
            MailhostPassword =PeaceConstConfig.MailhostPassword;
            FromAddress = PeaceConstConfig.FromAddress;
            MailHost = PeaceConstConfig.MailHost;
        }
